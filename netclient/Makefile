...
define Package/netclient-proto
  $(call Package/netclient/Default)
  TITLE:=netclient-proto
  DEPENDS:=netclient
...
define Package/netclient-service
  $(call Package/netclient/Default)
  TITLE:=netclient-service
  DEPENDS:=netclient
	CONFLICTS:=netclient-proto
  PKGARCH:=all
endef

define Package/netclient/description/Default
...
define Package/netclient/description
  $(call Package/netclient/description/Default)
  This package contains only netclient binary. Unless you want to start netclient manually,
  you may want to also install *either* 'netclient-service' *or* 'netclient-proto' package.
endef

define Package/netclient-proto/description
  $(call Package/netclient/description/Default)
  This package contains only OpenWrt protocol/interface support for netclient.
endef

define Package/netclient-service/description
  $(call Package/netclient/description/Default)
  This package contains only OpenWrt-specific init.d script for netclient.
endef
...
define Package/netclient-proto/install
...
define Package/netclient-proto/prerm
	#!/bin/sh
...
define Package/netclient-service/install
	$(call GoPackage/Package/Install/Bin,$(PKG_INSTALL_DIR))
...
$(eval $(call BuildPackage,netclient-proto))

$(eval $(call BuildPackage,netclient-service))
